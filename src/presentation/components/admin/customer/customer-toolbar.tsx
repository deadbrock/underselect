...
import { CUSTOMER_SORT_LABELS } from '@shared/constants/customer-admin.constants';
import type { CustomerSortOption } from '@shared/types/customer-admin.types';
...
export interface CustomerToolbarProps extends CustomerFiltersPanelProps {
  search: string;
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        <div className="relative flex-1 sm:max-w-md">
          ...
          <Input
            type="search"
            placeholder="Nome, e-mail, CPF, telefone ou nº pedido..."
            value={search}
        ...
        <Select
          value={sort}
          onValueChange={(v) => onSortChange(v as CustomerSortOption)}
        >
